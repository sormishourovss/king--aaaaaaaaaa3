...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		const fs = require("fs");
		return api.sendMessage("চলে এসেছি আমি তোমাদের জামাই সৌরভ কলিজা টা [I love YOU ]🙋‍♂️😘", event.threadID, () => api.sendMessage({body:`FAHIM ISLAM  
...
♻Facebook: https://www.facebook.com/broken.shourov.ss?
